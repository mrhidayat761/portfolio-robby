...
// --- PERBAIKAN 1: Tambahkan tipe data untuk Props Logo ---
...
export default function PortfolioFullStack() {
  ...
  // --- PERBAIKAN 2: Tambahkan ': string' di sini ---
  const scrollToSection = (item: string) => {
    ...
    // Cek apakah targetId ada isinya
    if (targetId) {
  ...
  // --- PERBAIKAN 3: Tambahkan ': string' di sini juga ---
