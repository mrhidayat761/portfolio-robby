...
// --- PERBAIKAN 1: Menambahkan tipe data pada props komponen ---
...
export default function PortfolioFullStack() {
  ...
  // --- PERBAIKAN 2: Menambahkan ': string' agar TypeScript tidak error ---
  const scrollToSection = (item: string) => {
    setIsMobileMenuOpen(false);
    let targetId = "";
    if (item === 'About') targetId = "about"; // Pastikan section about punya id="about"
    ...
    // Safety check biar tidak error kalau element tidak ketemu
    if (targetId) {
  ...
  // --- PERBAIKAN 3: Menambahkan ': string' di sini juga ---
          ...
          <div className="relative">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-white/70 backdrop-blur-sm p-6 rounded-xl border border-cyan-200/50 shadow-sm hover:shadow-md hover:border-cyan-300/70 transition group cursor-pointer">
                ...
                <p className="text-xs text-slate-600 mt-1">MongoDB, PostgreSQL</p>
              </div>
              <div className="bg-white/70 backdrop-blur-sm p-6 rounded-xl border border-sky-200/50 shadow-sm hover:shadow-md hover:border-sky-300/70 transition group cursor-pointer">
                ...
                <p className="text-xs text-slate-600 mt-1">Git, Docker, AWS</p>
              </div>
            </div>
          </div>
        </div>
