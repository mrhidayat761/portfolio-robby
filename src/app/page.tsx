...
// --- BAGIAN 1: PERBAIKAN TIPE DATA (String & Number) ---
...
export default function PortfolioFullStack() {
  ...
  // --- BAGIAN 2: PERBAIKAN FATAL (WAJIB ADA ': string') ---
  ...
  // --- BAGIAN 3: PERBAIKAN FATAL (WAJIB ADA ': string') ---
          ...
          <div className="flex justify-between items-center relative z-10">
            ...
            <div className="hidden md:flex gap-12">
              {[
                ...
                <button 
                  key={item.name} 
                  onClick={() => scrollToSection(item.id)} // Menggunakan item.id sebagai string
